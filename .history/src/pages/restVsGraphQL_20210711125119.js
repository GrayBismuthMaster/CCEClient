...
const RestVsGraphQL = () => {
    ...
    const [dateEndRest, setDateEndRest] = useState(0)
    ...
    let dateEndRest = new Date();
        useEffect(() => {
            ...
            console.log(endRest)
            setDateEndRest(new Date(endRest);
        }, [])
    ...
    return (
        ...
        <div className='mainContainerRVG'>
            ...
            <div className='containerRest'>
                     ...
                     de uso de internet"</text>
                    <li style={{marginTop:"4vh"}}>
                        Tiempo de inicio: {`${dateStartRest.toTimeString().substring(0,8)} ${dateStartRest.getMilliseconds()} ms`}
                    </li>
                    <li>
                        Tiempo de finalización: {`${dateEndRest.toTimeString().substring(0,8)} ${dateEndRest.getMilliseconds()} ms`} 
                    </li>
                    <li>
