                ...
                
                {
                    ...
                    <div style={{
                            ...
                            <div style={{
                                ...
                                padding:'10% 2% 2% 2%'
                                    ...
                                    <text style={{
                                       ...
                                       José Luis Mise Pasuña<br></br>
                                        <text style={{fontWeight:'bold'}}>Nacionalidad:</text> Ecuatoriana<br></br>
                                        <text style={{fontWeight:'bold'}}> Formación profesional:</text> Ingeniero En Sistemas e Informática graduado en la Universidad de las Fuerzas Armadas ESPE. Tecnólogo en Aviónica (Electrónica de Aviones) del Instituto Tecnológico Superior Aeronáutico.
                        ...
                        <div style={{
                          ...
                          Posgrado en Ingeniería en software en Universidad de las Fuerzas Armadas ESPE
                            Catedrático Universitario en la Carrera de Computación, Redes  y Telecomunicaciones Asignaturas: Sistemas Operativos I, Sistemas Operativos II, Estructura de datos, Proyecto Integrador II, Mantenimiento de Hardware I, Mantenimiento de Hardware II, Elementos y mantenimiento del PC, Fundamentos de Tics, Paquetes Informáticos en la Unidad de Gestión de Tecnologías de la Universidad de las Fuerzas Armadas ESPE.
  <br></br>
                             <text style={{fontWeight:'bold'}}>Contacto</text>
                             <br></br><text style={{fontWeight:'bold'}}>Correo Electrónico: </text>
                            joseluismisep@gmail.com
