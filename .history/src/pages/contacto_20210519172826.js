                    ...
                    <div className="containerContactoLeft">
                        ...
                        <div className="containerContactoLeftImagen">
                            ...
                            <div style={{
                                ...
                                fontSize:'1.2vw',
                                       ...
                                       <h2 style={{fontWeight:'bold'}}>José Luis Mise Pasuña</h2>
                                        <h2 style={{fontWeight:'bold'}}>Nacionalidad:</h2> Ecuatoriana
                                        <h2 style={{fontWeight:'bold'}}> Formación profesional:</h2> Ingeniero en Informática y 
                        ...
                        <div style={{
                            ...
                            Posgrado en Ingeniería en software en Universidad de las Fuerzas Armadas ESPE
                             ...
                             <br></br><h2 style={{fontWeight:'bold'}}>Correo Electrónico: </h2>
                            joseluismisep@gmail.com -
                            jlmise@espe.edu.ec
                            <br></br>
                            <h2 style={{fontWeight:'bold'}}>Teléfono móvil:</h2> 0998679276
                            <br></br>
                            <h2 style={{fontWeight:'bold'}}>Teléfono fijo:</h2> 032729637
                ...
                
                {
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                fontSize:'1.2vw'
                                       ...
                                       <h2 style={{fontWeight:'bold'}}>José Rubén Caiza Caizabuano</h2><br></br>
                                        <h2 style={{fontWeight:'bold'}}>Nacionalidad:</h2> Ecuatoriana<br></br>
                                        <h2 style={{fontWeight:'bold'}}> Formación profesional:</h2> Ingeniero En Sistemas e Informática graduado en la Universidad de las Fuerzas Armadas ESPE. Tecnólogo en Aviónica
                                         (Electrónica de
                            </div>
                    </div>
                        ...
                        <div style={{
                            ...
                            jrcaiza@espe.edu.ec
                            <br></br>
                            <h2 style={{fontWeight:'bold'}}>Teléfono móvil:</h2> 0984552122
                            <br></br>
                            <h2 style={{fontWeight:'bold'}}>Teléfono fijo:</h2> 032801452
