        ...
        <div style={{
            ...
            <div style={{   display:"flex",
                ...
                <ul style={{
                    ...
                    <text style={{
                        fontWeight:'bold'
                    }}>Análisis de tiempo de respuesta API GraphQL con la peticiónal endpoint "Frecuencia
            ...
            <div style={{   display:"flex",
                      ...
                      <ul>
                    Análisis de tiempo de respuesta API REST con la petición al endpoint "Frecuencia de uso de Internet"
