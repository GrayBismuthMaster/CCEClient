...
const despliegueEstadisticas = () => {
    return (
         ...
         <div style={{
             ...
             <div style={{
                    ...
                    <ul className="nav">
                        ...
                        <li><a href="#frecuenciaCompraNoCompra">Frecuencia de uso de Internet</a></li>
                        <li>Razones para no comprar</li>
                        <li>Motivaciones para comprar </li>
                    </ul>
        ...
        <div id="frecuenciaUsoInternet" style={{
            display:"flex",
            height:"100vh",
