                        ...
                        <div className="containerContactoLeftImagen">
                            ...
                            <div style={{
                                ...
                                fontSize:'1.2vw',
                                       ...
                                       <p style={{fontWeight:'bold'}}>José Luis Mise Pasuña</p><br></br>
                            ...
                            <div style={{
                                ...
                                fontSize:'1.2vw'
                                       ...
                                       <p style={{fontWeight:'bold'}}>José Rubén Caiza Caizabuano</p><br></br>
                                        <p style={{fontWeight:'bold'}}>Nacionalidad:</text> Ecuatoriana<br></br>
                                        <p style={{fontWeight:'bold'}}> Formación profesional:</text> Ingeniero En Sistemas e Informática graduado en la Universidad de las Fuerzas Armadas ESPE. Tecnólogo en Aviónica
                                         (Electrónica de
                            </div>
                    </div>
