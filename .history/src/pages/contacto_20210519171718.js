                ...
                
                {
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <br></br>
                             <p style={{fontWeight:'bold'}}>Contacto</text>
                             <br></br><p style={{fontWeight:'bold'}}>Correo Electrónico: </text>
                             joseru82@hotmail.com -                             
                            jrcaiza@espe.edu.ec
                            <br></br>
                            <p style={{fontWeight:'bold'}}>Teléfono móvil:</text> 0984552122
                            <br></br>
                            <p style={{fontWeight:'bold'}}>Teléfono fijo:</text> 032801452
