        ...
        <div className="mainContainerContacto">
                    ...
                    <div className="containerContactoLeft">
                        ...
                        <div className="containerContactoLeftImagen">
                            <img src={ContactoIngMise} className="imgIngMise" alt='imgIngMise'>  
                            </img>
                        </div>
                ...
                
                {
                    ...
                    <div className="containerContactoLeftCaiza">
                        ...
                        <div className='containerContactoLeftCaizaImagen'>
                            <img src={ContactoIngCaiza} className='imgIngCaiza' alt='Imagen ing Caiza'></img>
                        </div>

                            <div className='contactoDerechaTextoCaiza' >    
                        ...
                        <div className='contactoAbajoTextoCaiza' style={{
                            height:'45vh',
                            width:'50vw',
