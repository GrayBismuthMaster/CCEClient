...
const despliegueEstadisticas = () => {
    return (
        <>
         ...
         <div id="inicio" className="portadaImg" style={{
              display:"flex",
              height:"90vh",
        ...
        <div id="frecuenciaUsoInternet" className='mainContainerFrecuenciaUsoInternet' style={{
            display:"flex",
            height:"100vh",
            ...
            <div className='containerFrecuenciaUsoInternet' style={{
                    display: 'flex',
                    width:'100vw',
                    height:'100vh',
