...
const VerticalChartMotivacionComprar2020 = () => {
    ...
    if(loading){
        ...
        return (
          ...
          //Graficas
          const datosVertical = [
              { name: 'Informacion y guía para la compra', valor: data.obtenerMotivacionCompra2020.garantiaDevolucionCambio },
              { name: 'Gara', valor: data.obtenerMotivacionCompra2020.garantiaConfidencialidadInformacion },
