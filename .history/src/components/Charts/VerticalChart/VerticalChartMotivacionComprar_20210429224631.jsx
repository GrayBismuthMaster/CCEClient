    ...
    if(loading){
        ...
        return (
          ...
          const datosGrafica = [
              ...
              { name: 'Más información de cómo comprar', value: data.obtenerMotivacionCompra.garantiaDevolucionCambio },
              { name: 'Atención al cliente durante la compra', value: data.obtenerMotivacionCompra.garantiaConfidencialidadInformacion }
            ];
