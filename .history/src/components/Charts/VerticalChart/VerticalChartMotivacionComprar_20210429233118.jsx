    ...
    if(loading){
        ...
        return (
          ...
          const datosVertical = [
              ...
              { name: 'Garantía de confidencialidad de información', valor: data.obtenerMotivacionCompra.garantiaConfidencialidadInformacion },
              ...
              { name: 'Asistencia durante el proceso', valuedata.obtenerMotivacionCompra.asistenciaDuranteProceso },
