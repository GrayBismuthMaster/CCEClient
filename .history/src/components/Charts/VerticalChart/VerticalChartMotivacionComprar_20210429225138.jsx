    ...
    if(loading){
        ...
        return (
          ...
          const datosGrafica = [
              ...
              { name: 'Asistencia durante el proceso', value: data.obtenerMotivacionCompra.asistenciaDurante },
              ...
              { name: 'Mayor variedad de ofertas', value: data.obtenerMotivacionCompra.garantiaConfidencialidadInformacion },
              { name: 'Tutoriales o inducción para comprar', value: data.obtenerMotivacionCompra.garantiaDevolucionCambio },
              { name: 'Otras', value: data.obtenerMotivacionCompra.garantiaConfidencialidadInformacion }
            ];
