    ...
    return (
        ...
        <div style={{
            ...
            <div style={{
                ...
                La API de la CECE es una interface para programadores, estadistas, y ciudadanos que desean integrar los contenidos de este portal en sitios web, aplicaciones móviles, herramientas de análisis de datos, etc.
