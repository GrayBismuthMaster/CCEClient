...
const PlaygroundRest = () => {
    ...
    const funcFrecuencia= ()=>{
      ...
      //  }, [])
            return (
                <>
                <div className='datosFrecuencia' style={{color:'#23527c'}}>{datosFrecuencia}
                    <br></br><br></br> 
                </div>
    ...
    return (
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    marginLeft:'15vw'
                }}><span>La API de Gob.Ec es una interfaz para programadores, estadistas, y ciudadanos que desean integrar los contenidos de este portal en sitios web, aplicaciones móviles, herramientas de análisis de datos, etc.
...
</span>                  <br></br><br></br> <span style={{color:'#c7254e'}}>Endpoint: https://salty-fjord-38974.herokuapp.com/</span> </div>
            </div>
            <div style={{
                display:'flex',
                width:'100%',
