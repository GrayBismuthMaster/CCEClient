...
const PlaygroundRest = () => {
    ...
    const funcFrecuencia= ()=>{
      ...
      //  }, [])
            return (
                <>
                <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'5%',marginRight:'5%'}}>{datosFrecuencia}
                    <br></br><br></br> 
                </div>
    ...
    const funcMotivoNoCompra= ()=>{
      ...
      //  }, [])
            return (
                <>
                    <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)'}}>{datosMotivoNoCompra}<br></br><br></br> </div>
                    <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
                    <div style={{marginTop:'-10px', color:'white', marginLeft:'5%'}}>
                        <br></br><br></br>Este endpoint obtiene información referente al número de personas que respondieron a motivos por los cuales no realizaban
                        realizan compras por internet incluyendo miedo o desconfianza como un motivo muy influyente
                    </div>
                </>
            )
    }
    const funcCompraNoCompra= ()=>{
      ...
      //  }, [])
            return (
                <>
                    <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'5%',marginRight:'5%'}}>{datosCompraNoCompra}<br></br><br></br> </div>
                    <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
                    <div style={{marginTop:'-10px', color:'white'}}>
                        <br></br><br></br>Este endpoint obtiene información referente al número de personas que compran por internet y el número de personas
                        que no lo hacen
                    </div>
                </>
            )
    ...
    const funcFrecuencia2018 = ()=>{
      ...
      //  }, [])
            return (
            <>
                <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'5%',marginRight:'5%'}}>{datosFrecuencia2018}<br></br><br></br> </div>
                <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
                <div style={{marginTop:'-10px', color:'white'}}>
                    <br></br><br></br>Este endpoint obtiene información referente al número de personas que usan internet con la frecuencia de todos los
                    días, cada dos días y así sucesivamente del año 2018
                </div>
            </>
            )
    }
  ...
  //  }, [])
        return (
                <>
                    <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'5%',marginRight:'5%'}}>{datosMotivoNoCompra2018}<br></br><br></br> </div>
                    <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
                    <div style={{marginTop:'-10px', color:'white'}}>
                        <br></br><br></br>Este endpoint obtiene información referente al número de personas que respondieron a motivos por los cuales no realizaban
                        realizan compras por internet en el año 2018
                    </div>
                </>
        )
    }
    const funcCompraNoCompra2018= ()=>{
      ...
      //  }, [])
            return (
                <>
                    <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'5%',marginRight:'5%'}}>{datosCompraNoCompra2018}<br></br><br></br> </div>
                    <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
                    <div style={{marginTop:'-10px', color:'white'}}>
                        <br></br><br></br>Este endpoint obtiene información referente al número de personas que compran por internet y el número de personas
                        que no lo hacen en el año 2018
                    </div>
                </>
            )
    }
  ...
  //  }, [])
        return (
            <>
            <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'5%',marginRight:'5%'}}>{datosFrecuencia2020}<br></br><br></br> </div>
            <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
            <div style={{marginTop:'-10px', color:'white'}}>
                <br></br><br></br>Este endpoint obtiene información referente al número de personas que usan internet con la frecuencia de todos los
                días, cada dos días y así sucesivamente del año 2020
            </div>
        </>
        )
    }
  ...
  //  }, [])
        return (
            <>
            <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'5%',marginRight:'5%'}}>{datosMotivoNoCompra2020}<br></br><br></br> </div>
            <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
            <div style={{marginTop:'-10px', color:'white'}}>
                <br></br><br></br>Este endpoint obtiene información referente al número de personas que respondieron a motivos por los cuales no realizaban
                realizan compras por internet en el año 2020
            </div>
        </>
        )
    }
    const funcCompraNoCompra2020= ()=>{
      ...
      //  }, [])
            return (
            <>
                <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'5%',marginRight:'5%'}}>{datosCompraNoCompra2020}<br></br><br></br> </div>
                <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
                <div style={{marginTop:'-10px', color:'white'}}>
                    <br></br><br></br>Este endpoint obtiene información referente al número de personas que compran por internet y el número de personas
                    que no lo hacen en el año 2020
                </div>
            </>
            )
    }
    ...
    const funcMotivacionCompra= ()=>{
      ...
      //  }, [])
            return (
            <>
                <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'15%',marginRight:'15%',wordBreak:'break-word'}}>{datosMotivacionCompra}<br></br><br></br> </div>
                <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
                <div style={{marginTop:'-10px', color:'white'}}>
                    <br></br><br></br>Este endpoint obtiene información referente a las posibles motivaciones que ayuden en la mejoria del porcentaje
                     de personas que realizan compras en línea
    ...
    const funcMotivacionCompra2018= ()=>{
      ...
      //  }, [])
            return (
            <>
                <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'15%',marginRight:'15%',wordBreak:'break-word'}}>{datosMotivacionCompra2018}<br></br><br></br> </div>
                <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
                <div style={{marginTop:'-10px', color:'white'}}>
                    <br></br><br></br>Este endpoint obtiene información referente a las posibles motivaciones que ayuden en la mejoria del porcentaje
                     de personas que realizan compras en línea en el año 2018
    ...
    const funcMotivacionCompra2020= ()=>{
      ...
      //  }, [])
            return (
            <>
                <div className='datosFrecuencia' style={{color:'rgb(255, 215, 0)', marginLeft:'15%',marginRight:'15%',wordBreak:'break-word'}}>{datosMotivacionCompra2020}<br></br><br></br> </div>
                <span style={{fontWeight:'bold', color:'white'}}>Descripción</span>
                <div style={{marginTop:'-10px', color:'white'}}>
                    <br></br><br></br>Este endpoint obtiene información referente a las posibles motivaciones que ayuden en la mejoria del porcentaje
                     de personas que realizan compras en línea en el año 2018
