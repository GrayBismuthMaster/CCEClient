    ...
    return (
        ...
        <div style={{
                            ...
                            <div className='dropdown-second'>
                                <button className='second-drop-btn'>2019-2020</button>     
                                    <div className='dropdown-second-content'>
                                        ...
                                        <a onClick={setEndpointCompraNoCompra2020 } >api/compraNoCompra2018/</a>
                                    </div>
                            </div>
                            {
                                /*
            ...
            <div style={{
                ...
                {
                    frecuencia && !motivoNoCompra && !frecuencia2018 && !motivoNoCompra2018 && !frecuencia2020 && !motivoNoCompra2020 && !compraNoCompra && !compraNoCompra2018 ? funcFrecuencia() : null
                }  

                
                {
                    motivoNoCompra && !frecuencia && !frecuencia2018 && !motivoNoCompra2018 && !frecuencia2020 && !motivoNoCompra2020 && !compraNoCompra && !compraNoCompra2018 ?  funcMotivoNoCompra() : null
                }  
                {
                    frecuencia2018 && !frecuencia && !motivoNoCompra && !motivoNoCompra2018 && !frecuencia2020 && !motivoNoCompra2020 && !compraNoCompra && !compraNoCompra2018 ? funcFrecuencia2018() : null
                }
                {
                    motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 && !frecuencia2020 && !motivoNoCompra2020 && !compraNoCompra && !compraNoCompra2018 ? funcMotivoNoCompra2018() : null
                }
                {
                    frecuencia2020 && !motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 && !motivoNoCompra2020 && !compraNoCompra && !compraNoCompra2018 ? funcFrecuencia2020() : null
                }
                {
                    motivoNoCompra2020 && !frecuencia2020 && !motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 && !compraNoCompra && !compraNoCompra2018 ? funcMotivoNoCompra2020() : null
                }
                {
                    compraNoCompra && !motivoNoCompra2020 && !frecuencia2020 && !motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 && !compraNoCompra2018 ? funcCompraNoCompra() : null
                }
                {
                    compraNoCompra2018 &&  !compraNoCompra && !motivoNoCompra2020 && !frecuencia2020 && !motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 ? funcCompraNoCompra2018() : null
                }
            </div>
        </div>
        </>
