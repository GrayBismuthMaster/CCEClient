    ...
    return (
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    marginLeft:'15vw'
                }}><span></span>La API de Gob.Ec es una interfaz para programadores, estadistas, y ciudadanos que desean integrar los contenidos de este portal en sitios web, aplicaciones móviles, herramientas de análisis de datos, etc.
