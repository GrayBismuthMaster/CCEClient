...
const PlaygroundRest = () => {
   ...
   const [datosMotivoNoCompra2018, setDatosMotivoNoCompra2018] 
   //Booleanos funciones
    ...
    return (
        ...
        <div style={{
            ...
            <div style={{
                ...
                {
                    frecuencia && !motivoNoCompra && !frecuencia2018 ? funcFrecuencia() : null
                }  

                
                {
                    motivoNoCompra && !frecuencia && !frecuencia2018 ? funcMotivoNoCompra() : null
                }  
                {
                    frecuencia2018 && !frecuencia && !motivoNoCompra ? funcFrecuencia2018() : null
                }
            </div>
        </div>
        </>
