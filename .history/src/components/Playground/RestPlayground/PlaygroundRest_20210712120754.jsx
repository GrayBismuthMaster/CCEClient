    ...
    return (
        ...
        <div style={{
                            ...
                            <div className='dropdown-second'>
                                <button className='second-drop-btn'>2018</button>     
                                    <div className='dropdown-second-content'>
                                        ...
                                        <a onClick={setEndpointCompraNoCompra } >api/compraNoCompra2018/</a>
                                    </div>
                            </div>
                            <div className='dropdown-second'>
            ...
            <div style={{
                ...
                {
                    frecuencia && !motivoNoCompra && !frecuencia2018 && !motivoNoCompra2018 && !frecuencia2020 && !motivoNoCompra2020 && !compraNoCompra ? funcFrecuencia() : null
                }  

                
                {
                    motivoNoCompra && !frecuencia && !frecuencia2018 && !motivoNoCompra2018 && !frecuencia2020 && !motivoNoCompra2020 && !compraNoCompra ?  funcMotivoNoCompra() : null
                }  
                {
                    frecuencia2018 && !frecuencia && !motivoNoCompra && !motivoNoCompra2018 && !frecuencia2020 && !motivoNoCompra2020 && !compraNoCompra ? funcFrecuencia2018() : null
                }
                {
                    motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 && !frecuencia2020 && !motivoNoCompra2020 && !compraNoCompra ? funcMotivoNoCompra2018() : null
                }
                {
