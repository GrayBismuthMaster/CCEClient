...
const PlaygroundRest = () => {
   ...
   const [datosMotivoNoCompra2020, setDatosMotivoNoCompra2018] = useState('') 
   //Booleanos funciones
    ...
    return (
        ...
        <div style={{
            ...
            <div style={{
                ...
                {
                    frecuencia && !motivoNoCompra && !frecuencia2018 && !motivoNoCompra2018 && !frecuencia2020  ? funcFrecuencia() : null
                }  

                
                {
                    motivoNoCompra && !frecuencia && !frecuencia2018 && !motivoNoCompra2018 && !frecuencia2020 ?  funcMotivoNoCompra() : null
                }  
                {
                    frecuencia2018 && !frecuencia && !motivoNoCompra && !motivoNoCompra2018 && !frecuencia2020 ? funcFrecuencia2018() : null
                }
                {
                    motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 && !frecuencia2020 ? funcMotivoNoCompra2018() : null
                }
                {
                    frecuencia2020 && !motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 ? funcFrecuencia2020() : null
                }
            </div>
        </div>
        </>
