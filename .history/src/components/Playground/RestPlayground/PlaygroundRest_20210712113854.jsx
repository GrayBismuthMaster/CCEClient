  ...
  //  }, [])
    ...
    const funcMotivoNoCompra2020 = ()=>{
        ...
        .then(result=>{
            console.log(result)
            const nuevo = JSON.stringify(result.data)
            setDatosMotivoNoCompra20202(nuevo)
        }
        ).catch(console.log() )
  //  }, [])
        return (
    ...
    return (
        ...
        <div style={{
            ...
            <div style={{
                ...
                {
                    motivoNoCompra2020 && frecuencia2020 && !motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018  ? funcFrecuencia2020() : null
                }
            </div>
        </div>
        </>
