...
const PlaygroundRest = () => {
  ...
  //  }, [])
    ...
    const funcMotivacionCompra= ()=>{
      ...
      //  }, [])
            return (
                <div className='datosFrecuencia' >{datosMotivacionCompra}</div>
            )
    }
    ...
    return (
        ...
        <div style={{
            ...
            <div style={{
                ...
                {
                    motivacionCompra && !compraNoCompra2020 && !compraNoCompra2018 &&  !compraNoCompra && !motivoNoCompra2020 && !frecuencia2020 && !motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 && !motivacionCompra2018 && !motivacionCompra2020 ? funcCompraNoCompra2020() : null
                }
                {
                    motivacionCompra2018 && !motivacionCompra && !compraNoCompra2020 && !compraNoCompra2018 &&  !compraNoCompra && !motivoNoCompra2020 && !frecuencia2020 && !motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 && !motivacionCompra2020 ? funcCompraNoCompra2020() : null
                }
                {
                    motivacionCompra2020  && !motivacionCompra2018 && !motivacionCompra && !compraNoCompra2020 && !compraNoCompra2018 &&  !compraNoCompra && !motivoNoCompra2020 && !frecuencia2020 && !motivoNoCompra2018 && !frecuencia && !motivoNoCompra && !frecuencia2018 ? funcCompraNoCompra2020() : null
                }
            </div>
        </div>
        </>
