...
const Navbar = () => {
    ...
    const [dropdownDespliegueEstadistico, setDropdownDespliegueEstadistico]
    const handleClick = () => setClick(!click)
    const closeMobileMenu = () => setDropdown(!dropdown)
    const closeMobileMenuDespliegueEstadistico = () => setDropdown(!dropdown)
    return (
        <>
           <Nav>    
               <NavLink to='/'>
              ...
              
         {
               ...
               <Bars onClick={handleClick}/>
                ...
                <NavMenu style={{
                    ...
                    <Dropdown isOpen={dropdown} toggle={closeMobileMenuDespliegueEstadistico}>
                        <DropdownToggle>
