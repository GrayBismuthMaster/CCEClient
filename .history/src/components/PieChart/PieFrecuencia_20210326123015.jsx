...
import {useQuery,gql,inme} from '@apollo/client'
...
const {obtenerFrecuenciaUsoInternet} = client.cache.readQuery({
  query: FRECUENCIAUSOINTERNET
})
if(obtenerFrecuenciaUsoInternet){
  console.log(obtenerFrecuenciaUsoInternet)
}
