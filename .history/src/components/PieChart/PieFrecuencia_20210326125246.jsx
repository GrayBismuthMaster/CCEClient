...
`
const frecuenciaCache = client.readQuery({ query: FRECUENCIAUSOINTERNET });
if(someQueryResult){
  console.log(frecuenciaCache.obtenerFrecuenciaUsoInternet)
...
if(loading){
  return (
    ...
    //Graficas
    const datosGrafica = [
        { name: 'Todos los días', value: frecuenciaCache.obtenerFrecuenciaUsoInternet.TodosLosDias },
        { name: 'Cada dos días', value: frecuenciaCache.obtenerFrecuenciaUsoInternet.CadaDosDias },
        { name: 'Cada tres días', value: frecuenciaCache.obtenerFrecuenciaUsoInternet.CadaTresDias },
        { name: 'Cada cuatro días', value:frecuenciaCache.obtenerFrecuenciaUsoInternet.CadaCuatroDias},
      ];
