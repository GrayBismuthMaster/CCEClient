...
const [datosCache,setDatosCache] = ([]);
const someQueryResult = client.readQuery({ query: FRECUENCIAUSOINTERNET });
if(someQueryResult){
  console.log(someQueryResult)
  console.log("si hay datos")
  setDatosCache = [
    { name: 'Todos los días', value: someQueryResult.obtenerFrecuenciaUsoInternet.TodosLosDias },
    { name: 'Cada dos días', value: someQueryResult.obtenerFrecuenciaUsoInternet.CadaDosDias },
    { name: 'Cada tres días', value: someQueryResult.obtenerFrecuenciaUsoInternet.CadaTresDias },
    { name: 'Cada cuatro días', value:someQueryResult.obtenerFrecuenciaUsoInternet.CadaCuatroDias},
  ];
  console.log(datosCache[0])
}
